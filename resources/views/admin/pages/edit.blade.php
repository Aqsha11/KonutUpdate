...
<div class="page-header">
    <div>
        <h1>Edit Halaman</h1>
        <p class="page-subtitle">Perbarui halaman statis</p>
    </div>
...
<div class="form-card">
    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Judul Halaman" value="{{ old('title', $page->title) }}" required>
                    @error('title')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" placeholder="slug-halaman" value="{{ old('slug', $page->slug) }}" required>
                    @error('slug')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="editor" rows="12" class="form-control @error('content') is-invalid @enderror" placeholder="Tulis konten halaman di sini..." style="display:none;">{{ old('content', $page->content) }}</textarea>
        ...
        <div class="form-group">
            <div class="form-check">
                <input type="checkbox" name="is_published" id="is_published" class="form-check-input" value="1" {{ old('is_published', $page->is_published) ? 'checked' : '' }}>
