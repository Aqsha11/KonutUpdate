...
<head>
    ...
    <title>Lupa Password - {{ $site_settings['site_name'] ?? 'Konut.Update' }}</title>
...
<body>
    <div class="login-container">
        <div class="login-brand">
            <div class="login-brand-content">
                ...
                <h1>Reset Password<br>via <span>Verifikasi Email</span></h1>
                <p>Masukkan email terdaftar Anda. Kami akan mengirim link verifikasi untuk mengatur ulang kata sandi.</p>
                <div class="login-brand-steps">
                    <div class="login-brand-step">
                        <div class="step-icon">📧</div>
                        <span>Link reset dikirim ke email Anda</span>
                    </div>
                    <div class="login-brand-step">
                        <div class="step-icon">✅</div>
                        <span>Verifikasi email dengan mengeklik link</span>
                    </div>
                    <div class="login-brand-step">
                        <div class="step-icon">🔑</div>
                        <span>Buat kata sandi baru yang aman</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="login-form-wrapper">
            <div class="login-form-inner">
                <div class="login-form-header">
                    <h2>Lupa Password</h2>
                    <p>Masukkan email terdaftar untuk menerima link reset.</p>
                </div>
    ...
    <script>
        document.getElementById('forgotForm').addEventListener('submit', function() {
            ...
            btn.innerHTML = '<svg class="animate-spin" width="18" height="18" viewBox="0 0 24 24" fill="none" style="animation:spin 0.8s linear infinite"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" opacity="0.25"/><path d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" fill="currentColor" opacity="0.75"/></svg> Mengirim...';
            btn.disabled = true;
        });
    </script>
    <style>
