<footer class="bg-inverse-surface text-inverse-on-surface dark:bg-gray-900 dark:text-gray-300 mt-8 lg:mt-12">
    ...
    <div class="footer-wave">
        <svg viewBox="0 0 1440 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M0,20 C240,8 480,28 720,20 C960,8 1200,28 1440,20 L1440,32 L0,32 Z" fill="var(--color-accent, #F58220)" opacity="0.08"/>
        </svg>
    </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs list-none p-0">
                    ...
                    @if(!empty($site_settings['email']))
                        <li>
                            <a href="mailto:{{ $site_settings['email'] }}" class="flex gap-2 opacity-70 hover:opacity-100 transition-all no-underline text-inverse-on-surface dark:text-gray-300">
                                <i data-lucide="mail" class="w-3.5 h-3.5 mt-0.5 shrink-0"></i>
                    ...
                    @if(!empty($site_settings['phone']))
                        <li class="flex gap-2 opacity-70">
                            <i data-lucide="phone" class="w-3.5 h-3.5 mt-0.5 shrink-0"></i>
